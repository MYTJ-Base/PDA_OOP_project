...
This repository is organized to ensure clarity and modularity:

```text
/
├── assets/                 # Visual assets (flowcharts, UML diagrams, images)
├── data/                   # Persistent storage files (.txt)
├── docs/                   # Original project brief and instructions
├── sample_data/            # Reference data for testing
├── src/                    # C++ source code (.h, .cpp)
